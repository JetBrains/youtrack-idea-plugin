...
Plugin displays issue list maching the query set in server settings. When an issue is selected, issue preview appears with wiki warkup rendered. Issue comments and tags are coming soon.
